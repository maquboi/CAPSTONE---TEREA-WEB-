...
const mockActivities: Activity[] = [
  {
    ...
    description: "Juan Dela Cruz has been flagged as high-risk by AI",
    time: "5 min ago",
    user: "System",
  },
  {
    ...
    description: "Maria Santos scheduled for checkup on Feb 10",
    time: "15 min ago",
    user: "Dr. Santos",
  },
  {
    ...
    description: "Pedro Reyes moved to 'For Follow-up'",
    time: "1 hour ago",
    user: "Dr. Cruz",
  },
  {
    ...
    description: "Ana Garcia completed symptom assessment",
    time: "2 hours ago",
    user: "System",
  },
  {
    ...
    description: "January 2025 TB trend report is ready",
    time: "3 hours ago",
    user: "Admin",
  },
];
...
const getActivityIcon = (type: Activity["type"]) => {
  const icons = {
    "patient-added": UserPlus,
    appointment: Calendar,
    "status-update": ClipboardCheck,
    alert: AlertCircle,
    report: FileText,
    reminder: Bell,
  };
